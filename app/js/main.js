...
/* harmony import */ var _components_range_slider_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/range-slider.js */ "./src/js/components/range-slider.js");
/* harmony import */ var _components_modal_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/modal.js */ "./src/js/components/modal.js");
...
window.addEventListener('resize', (0,_functions_throttle_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(updateDeviceCapabilities, 300));
...
document.body.addEventListener('click', event => {
  ...
  if (btn) {
    ...
    document.querySelectorAll('[data-catalog-menu-id].is-show').forEach(menu => menu.classList.remove('is-show'));
    document.querySelectorAll('[data-catalog-menu-target].is-active').forEach(b => b.classList.remove('is-active'));
...
function setupHoverMenu() {
  ...
  buttons.forEach(btn => {
    ...
    const showMenu = () => {
      document.querySelectorAll('[data-catalog-menu-id].is-show').forEach(m => m.classList.remove('is-show'));
      document.querySelectorAll('[data-catalog-menu-target].is-active').forEach(b => b.classList.remove('is-active'));
      btn.classList.add('is-active');
...
window.addEventListener('resize', (0,_functions_throttle_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(() => {
  updateDeviceCapabilities();
  setupHoverMenu();
}, 300));
...
// сразу и по ресайзу
updateCapabilities();
window.addEventListener('resize', (0,_functions_throttle_js__WEBPACK_IMPORTED_MODULE_1__.throttle)(updateCapabilities, 300));
...
document.querySelectorAll('.range-slider-container')?.forEach(container => {
  ...
  const start = container.dataset.start.split(',').map(v => parseFloat(v.trim()));
  ...
  nouislider__WEBPACK_IMPORTED_MODULE_0__["default"].create(sliderEl, {
    start: start,
    connect: true,
    range: {
      min,
...
buttons.forEach(btn => {
  ...
  if (isTouch) {
    ...
    btn.addEventListener('mouseover', (0,_functions_throttle_js__WEBPACK_IMPORTED_MODULE_0__.throttle)(handler, 100));
  }
...
document.querySelectorAll('.portfolio-swiper')?.forEach(container => {
  ...
  swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](swiperEl, {
    init: false,
    slidesPerView: 'auto',
    centeredSlides: true,
    autoHeight: true,
    ...
    on: {
      ...
      resize: (0,_functions_throttle_js__WEBPACK_IMPORTED_MODULE_2__.throttle)(setSlideActiveSize, 100)
    }
  });
  setSlideActiveSize();
  swiper.init();
...
window.initializeTab = function (triggerEl) {
  const tab = new bootstrap_js_dist_tab_js__WEBPACK_IMPORTED_MODULE_0__(triggerEl);
